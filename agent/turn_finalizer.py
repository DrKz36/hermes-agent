...
def finalize_turn(
    ...
    *,
    ...
    if iteration_limit_fallback:
        ...
        if _kanban_task and not getattr(agent, "no_tools", False):
            try:
    ...
    if final_response and not interrupted and not getattr(agent, "no_tools", False):
        try:
    ...
    if (
        final_response
        and not interrupted
        and not getattr(agent, "no_tools", False)
